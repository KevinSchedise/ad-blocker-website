...
export function CreativePricing({
  ...
  description = "Get the features you need at a price that works for you!",
  tiers,
}: {
  tag?: string;
  title?: string;
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4">
      <div className="text-center space-y-6 mb-16">
        <div className="font-medium text-xl text-schedise-indigo">{tag}</div>
            ...
            <div className="relative p-6">
              ...
              <Button
                className={cn(
                  ...
                  tier.popular
                    ? [
                        "bg-schedise-indigo text-white",
                        "hover:bg-schedise-indigo/90",
                        "active:bg-schedise-indigo",
                      ]
                    : [
                ...
                onClick={() => {
                  if (tier.buttonHref) {
                    window.location.href = tier.buttonHref;
                  }
                }}
              >
